...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		ArrayList<Transaction> selectedItems = new ArrayList<>();
		...
		RemoveTransactionsCommand remover = new RemoveTransactionsCommand(selectedItems, data);
		commandRegistry.executeCommand(remover);
	}
